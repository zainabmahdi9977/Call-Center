...
mixin Dispatcher on LifeCycle, Reader {
  late StreamController<Response> _responseStream;
  late StreamController<Event> _eventStream;
  late StreamSubscription<Event> _eventDispatcher;
  late StreamSubscription<Response> _respDispatcher;

  final Map<String, StreamController<Event>> _eventListeners = {};
  final Map<String, StreamController<Response>> _respListeners = {};
